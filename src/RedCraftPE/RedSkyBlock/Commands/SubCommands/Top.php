...
use pocketmine\player\Player; // Changed from pocketmine\command\CommandSender to pocketmine\player\Player
...
class Top {
  ...
  public function NCDTopForm(Player $sender, string $text) { // Changed parameter type from CommandSender to Player
  ...
  public function onTopCommand(CommandSender $sender): bool {
    ...
    if ($sender instanceof Player && $sender->hasPermission("skyblock.top")) { // Check if $sender is a Player and has permission
